...
class PaginaMenuNino extends StatefulWidget {
  @override
  _PaginaMenuNinoState createState() => _PaginaMenuNinoState();
}

class _PaginaMenuNinoState extends State<PaginaMenuNino> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Menu de ropa de niño')),
  ...
  Widget _crearListado(numero) {
    return FutureBuilder(
      future: productosProvider.cargarProductoNino(numero),
      builder:
