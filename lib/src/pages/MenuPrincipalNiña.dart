...
class PaginaMenuNina extends StatefulWidget {
  @override
  _PaginaMenuNinaState createState() => _PaginaMenuNinaState();
}

class _PaginaMenuNinaState extends State<PaginaMenuNina> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Menu de ropa de niña')),
  ...
  Widget _crearListado(numero) {
    return FutureBuilder(
      future: productosProvider.cargarProductoNina(numero),
      builder:
