...
class PaginaMenuHombre extends StatefulWidget {
  @override
  _PaginaMenuHombreState createState() => _PaginaMenuHombreState();
}

class _PaginaMenuHombreState extends State<PaginaMenuHombre> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Menu de ropa de hombre')),
  ...
  Widget _crearListado(numero) {
    return FutureBuilder(
      future: productosProvider.cargarProductoHombre(numero),
      builder:
